...
namespace BeerStore.Application.Modules.Auth.Permissions.Commands.UpdatePermission
{
    public class UpdatePermissionCHandler : IRequestHandler<UpdatePermissionCommand, PermissionResponse>
    {
        ...
        public UpdatePermissionCHandler(IAuthUnitOfWork auow, ILogger<UpdatePermissionCHandler> logger, IAuthAuthorizationService authService)
        {
            _auow = auow;
            _logger = logger;
        ...
        {
            _authService.EnsureCanUpdatePermission();
