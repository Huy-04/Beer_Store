...
using BeerStore.Application.Modules.Shop.StoreAddresses.Commands.CreateStoreAddress;
using BeerStore.Application.Modules.Shop.StoreAddresses.Commands.RemoveStoreAddress;
using BeerStore.Application.Modules.Shop.StoreAddresses.Commands.UpdateStoreAddress;
using BeerStore.Application.Modules.Shop.StoreAddresses.Queries.GetStoreAddressById;
using BeerStore.Application.Modules.Shop.StoreAddresses.Queries.GetStoreAddressesByStore;
using MediatR;
...
namespace BeerStore.Api.Controllers.Shop
{
    ...
    public class StoreAddressController : BaseApiController
    {
        ...
        public StoreAddressController(IMediator mediator)
        {
            _mediator = mediator;
        }
