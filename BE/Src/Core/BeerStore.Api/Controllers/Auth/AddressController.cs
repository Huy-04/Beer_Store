...
using BeerStore.Application.Modules.Auth.Address.Commands.CreateAddress;
using BeerStore.Application.Modules.Auth.Address.Commands.RemoveAddress;
using BeerStore.Application.Modules.Auth.Address.Commands.UpdateAddress;
using BeerStore.Application.Modules.Auth.Address.Queries.GetAddressById;
using BeerStore.Application.Modules.Auth.Address.Queries.GetAddressByPhone;
using BeerStore.Application.Modules.Auth.Address.Queries.GetAllAddress;
using MediatR;
